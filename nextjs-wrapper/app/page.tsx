      ...
      <Container maxWidth="lg">
        ...
        >
          <Typography
            ...
            sx={{
              ...
              "@keyframes pulse": {
                ...
                "50%": {
                  textShadow:
                    "0 0 30px rgba(0, 255, 0, 1), 0 0 60px rgba(0, 255, 0, 0.6)",
                },
              },
            }}
          >
          ...
          <Button
            ...
            sx={{
              ...
              "&:hover": {
                ...
                boxShadow:
                  "0 0 40px rgba(0, 255, 0, 0.8), inset 0 0 30px rgba(0, 255, 0, 0.2)",
              },
              "&:active": {
          ...
          >
            ...
            <TickerTape text="Coming soon... Chess, Checkers, Backgammon, Global Thermonuclear ... :-) " />
          </Box>
        </Box>
      </Container>
